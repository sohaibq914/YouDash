...
function GroupComponent(props) {
  ...
  const getUser = () => {
    ...
    return theUrl.substring(
      theUrl.indexOf("/", 10) + 1,
      theUrl.indexOf("/", theUrl.indexOf("/", 10) + 1)
    );
  };
  ...
  useEffect(() => {
    ...
    getAllManagers();
    setProfilePic(
      group.profilePictureKey != "NULL"
        ? "https://profilepicture12.s3.us-east-2.amazonaws.com/" +
  ...
  const updatePic = (e) => {
    setSelectedFile(
      document.getElementById("picInput" + group.groupId).files[0]
    );
      ...
      {isManager ? (
        <>
          ...
          {profilePic ? (
            <>
              ...
              <br />
              <div style={{ textAlign: "center" }}>
                <button style={{ width: "50%" }} onClick={updatePic}>
                  Update
                </button>
              </div>
            </>
          ...
          <button
            style={{ width: "33.33%" }}
            onClick={() =>
              (window.location.href = `/${getUser()}/leaderboard/${group.groupId}`)
            }
          >
            Go to leaderboard
          </button>
          ...
          <button
            style={{ width: "33.33%" }}
            onClick={() =>
              (window.location.href = `group-chat/${group.groupId}`)
            }
          >
            Go to chat
          </button>
        ...
        <>
          ...
          <button
            style={{ width: "33.33%" }}
            onClick={() =>
              (window.location.href = `leaderboard/${group.groupId}`)
            }
          >
            Go to leaderboard
          </button>
          ...
          <button
            style={{ width: "33.33%" }}
            onClick={() => (window.location.href = `chat/${group.groupId}`)}
          >
            Go to chat
          </button>
          <button
